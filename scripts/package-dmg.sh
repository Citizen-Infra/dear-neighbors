...
DMG_NAME="Dear-Neighbors-v${VERSION}.dmg"
STAGE_DIR="$PROJECT_DIR/.dmg-stage"

echo "==> Packaging Dear Neighbors v${VERSION}"
...
cat > "$STAGE_DIR/Dear Neighbors/Open Extensions.command" <<'EOF'
#!/usr/bin/env bash
open "chrome://extensions"
EOF
chmod +x "$STAGE_DIR/Dear Neighbors/Open Extensions.command"
